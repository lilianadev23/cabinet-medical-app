            ...
            <div className="settings-panel">
              ...
              <div className="mt-2 d-table w-100 pl-5 pr-3">
                <div className="fs-xs text-muted p-2 alert alert-warning mt-3 mb-2">
                  <i className="fal fa-exclamation-triangle text-warning mr-2" />
                  The settings below uses localStorage to load the external CSS
                  file as an overlap to the base css. Due to network latency and
                  CPU utilization, you may experience a brief flickering effect
                  on page load which may show the intial applied theme for a
                  split second. Setting the prefered style/theme in the header
                  will prevent this from happening.
                </div>
              </div>
              <div className="mt-2 d-table w-100 pl-5 pr-3">
                <div className="d-table-cell align-middle">
                  <h5 className="p-0">Theme colors</h5>
                </div>
              </div>
              ...
              <div className="pl-5 pr-3 py-3 bg-faded">
                <div className="row no-gutters">
                  <div className="col-6 pr-1">
                    <a
                      href="#"
                      className="btn btn-outline-danger fw-500 btn-block"
                  ...
                  <div className="col-6 pl-1">
                    <a
                      href="#"
                      className="btn btn-danger fw-500 btn-block"
