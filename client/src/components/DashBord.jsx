...
import { Tooltip } from "react-tooltip"; // ✅ import correct pour react-tooltip v5
...
const DashBord = () => {
  ...
  // Fonction pour formater les heures (exemple : 10:00 - 11:00)
  const formatHours = (start, end) => {
    return `${moment(start).format("HH:mm")} - ${moment(end).format("HH:mm")}`;
  };

  // Composant événement avec tooltip HTML
  const CustomEvent = ({ event }) => {
    ...
    return (
      <span
        ...
        data-tooltip-html={tooltipContent} // ⚠️ ici on utilise data-tooltip-html pour HTML
          ...
          <div id="panel-1" className="panel">
            ...
            <div className="panel-container show">
              <div className="panel-content bg-subtlelight-fade">
                <div id="js-checkbox-toggles" className="d-flex mb-3"></div>
                <BarChart
                  dataset={dataset}
                  xAxis={[{ dataKey: "month" }]}
                  series={[
              ...
              <div className="panel-content poisition-relative">
                <div style={{ padding: "5px" }}>
                  ...
                  <Tooltip
                    ...
                    place="top"
                    effect="solid"
                    html={true} // ⚠️ active le rendu HTML dans tooltip
                  />
                </div>
              </div>
            </div>
                      ...
                      series={[
                        {
                          data: [
                            ...
                            { id: 1, value: 70000, label: "Médcin 1" },
                            { id: 2, value: 30000, label: "Médcin 2" },
                            {
                              id: 3,
                              value: 50000,
                              label: "Médcin 3",
    ...
    />
        ...
        <div className="col-lg-12">
          <div id="panel-4" className="panel">
            <div className="panel-hdr">
              <h2>
              Activité du jour – Liste des rendez-vous{" "}
                <span className="fw-300">
                  <i>(30 Patients en attente)</i>
                </span>
              </h2>
            </div>
            <div className="panel-container show">
